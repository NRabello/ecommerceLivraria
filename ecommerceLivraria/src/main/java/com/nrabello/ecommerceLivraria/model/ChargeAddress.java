...
@Entity
@Table(name="EnderecosCobranca")
public class ChargeAddress {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name="edc_id")
    private Long id;
    @Column(name="edc_tipo_residencia")
    @Enumerated(EnumType.STRING)
    private ETyperesidence typeresidence;
    @Column(name="edc_tipo_logradouro")
    private String patioType;
    @Column(name="edc_logradouro")
    private String publicArea;
    @Column(name="edc_numero")
    private String numberAddrs;
    @Column(name="edc_bairro")
    private String neighborhood;
    @Column(name="edc_cep")
    private String CEP;
    @Column(name="edc_cidade")
    private String city;
    @Column(name="edc_estado")
    private String state;
    @Column(name="edc_pais")
    private String country;
    @Column(name="edc_observacoes")
    private String observations;
    @Column(name = "edc_nome")
    private String nameAddrs;

    @ManyToOne
    @JoinColumn(name="edc_cli_id", referencedColumnName = "cli_id")
    @JsonIgnore
    ...
    public ChargeAddress(Long id, ETyperesidence typeresidence, String patioType, String publicArea, String numberAddrs, String neighborhood, String CEP, String city, String state, String country, String observations, Client client, String nameAddrs) {
        this.setId(id);
